...
export class GemeentenSelectieComponent implements OnInit {
  constructor(public gemeentenService: GemeentenService, private haltesService: HaltesService, public weerService: WeerService, public deLijnService: DeLijnService) {}
